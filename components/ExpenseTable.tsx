            ...
            <div className="bg-[#0e0e1a] border border-[#1e1e35] rounded-2xl overflow-hidden">
                ...
                {paginated.length === 0 ? (
                    ...
                    paginated.map((expense, idx) => {
                        const catStyle = EXPENSE_CATEGORY_COLORS[expense.category] ?? EXPENSE_CATEGORY_COLORS["Outros"];
                        return (
                            <div
                                key={expense.id}
                                ...
                                p === "..." ? (
                                    ...
                                    <button
                                        ...
                                        className={`w-7 h-7 flex items-center justify-center rounded-lg text-xs font-medium transition-colors
                                            ${safePage === p ? "bg-indigo-600 text-white" : "text-slate-400 hover:text-white hover:bg-[#1e1e35]"}`}
                                    >
                                        {p}
                                    </button>
                                )
